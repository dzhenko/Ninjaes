...
describe('troopsHandler', function () {
    beforeEach(function () {
        fakeInfo.user = {
            username: 'pesho',
            coordinates: {
    ...
    describe('#buyTroops', function () {
        ...
        it('if handler returns false when user does not have enough money to pay for the units he wants to buy', function () {
            ...
            fakeInfo.user.gold = 0;
            var actual = troopsHandler.buyTroops(information,gameData).success;
        ...
        it('if after buying new troops the amount of certain unit of troops the user owns has been properly increased', function () {
            ...
            var result = troopsHandler.buyTroops(information, gameData);
